...
# Define easy tasks for off days.
...
# Define off days of programs to assign easy tasks. 


# Ask the number of each program and save them. 
# Merge them in an order and calculate n.


# Pick the first list whose length exceed n. 
# Delete unneccesary tasks from the list. 
# Save it as the main task list.


# Now we know task lists, programs and their numbers, off days of programs, easy tasks. 
# Do we need to know something else? 
# I think we can now define the objective function by using n, weights, and the main task list. 
...
# Define Solution Method and solve the problem.
